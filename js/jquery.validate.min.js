        ...
        validate: function(e) {
            if (this.length) {
                ...
                return i || (this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.on("click.validate", ":submit", (function(e) {
                    ...
                    function s() {
                        var s, n;
                        return i.submitButton && (i.settings.submitHandler || i.formSubmitted) && (s = t("<input type='hidden'/>").attr("name", i.submitButton.name).val(t(i.submitButton).val()).appendTo(i.currentForm)),
                        !(i.settings.submitHandler && !i.settings.debug) || (n = i.settings.submitHandler.call(i, i.currentForm, e), s && s.remove(), void 0 !== n && n)
                    }
        ...
        rules: function(e, i) {
            ...
            if (null != h && (!h.form && u && (h.form = this.closest("form")[0], h.name = this.attr("name")), null != h.form)) {
                ...
                return (a = t.validator.normalizeRules(t.extend({},
                    t.validator.classRules(h), t.validator.attributeRules(h), t.validator.dataRules(h), t.validator.staticRules(h)), h)).required && (o = a.required, delete a.required, a = t.extend({
                        required: o
                    },
                    a)),
    ...
    t.extend(t.expr.pseudos || t.expr[":"], {
        ...
        t.extend(t.validator, {
            ...
            messages: {
                ...
                maxlength: t.validator.format("حداکثر {0} کارکتر وارد نمایید."),
                minlength: t.validator.format("حداقل {0} کارکتر وارد نمایید."),
                rangelength: t.validator.format("مقداری بین {0} تا {1} کاراکتر وارد کنید."),
                range: t.validator.format("لطفاً مقداری بین {0} و {1} وارد کنید."),
                max: t.validator.format("حداکثر تا {0} می‌توانید وارد کنید."),
                min: t.validator.format("حداقل تا {0} می‌توانید وارد کنید."),
                step: t.validator.format("لطفا مضربی از {0} را وارد کنید."),
            },
            autoCreateRanges: !1,
            prototype: {
                init: function() {
                ...
                element: function(e) {
                    ...
                    })), i = !1 !== this.check(r), o = o && i, this.invalid[r.name] = !i, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), t(e).attr("aria-invalid", !i)),
                        o
                },
                ...
                elements: function() {
                    ...
                    return t(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter((function() {
                        ...
                        n && (this.form = t(this).closest("form")[0], this.name = s),
                        this.form === e.currentForm && !(s in  i || !e.objectLength(t(this).rules())) && (i[s] = !0, !0)
                    }))
                },
                clean: function(e) {
                    return t(e)[0]
                ...
                check: function(e) {
                    ...
                    for (s in "function" == typeof a.normalizer ? r = a.normalizer : "function" == typeof this.settings.normalizer && (r = this.settings.normalizer), r && (h = r.call(e, h), delete a.normalizer), a) {
                        ...
                        try {
                            ...
                            if (!i) return this.formatAndAdd(e, n),
                                !1
                        } catch(t) {
                    ...
                    if (!l) return this.objectLength(a) && this.successList.push(e),
                        !0
                },
                ...
                defaultMessage: function(e, i) {
                    ...
                    var s = this.findDefined(this.customMessage(e.name, i.method), this.customDataMessage(e, i.method), !this.settings.ignoreTitle && e.title || void 0, t.validator.messages[i.method], "<strong>هشدار: هیچ پیامی برای آن تعریف نشده است" + e.name + "</strong>"),
                        n = /\$?\{(\d+)\}/g;
                    return "function" == typeof s ? s = s.call(this, i.parameters, e) : n.test(s) && (s = t.validator.format(s.replace(n, "{$1}"), i.parameters)),
                        s
                },
                ...
                stopRequest: function(e, i) {
                    ...
                    this.pendingRequest < 0 && (this.pendingRequest = 0),
                        ...
                        i && 0 === this.pendingRequest && this.formSubmitted && this.form() && 0 === this.pendingRequest ? (t(this.currentForm).trigger("submit"), this.submitButton && t("input:hidden[name='" + this.submitButton.name + "']", this.currentForm).remove(), this.formSubmitted = !1) : !i && 0 === this.pendingRequest && this.formSubmitted && (t(this.currentForm).triggerHandler("invalid-form", [this]), this.formSubmitted = !1)
                },
            ...
            normalizeAttributeRule: function(t, e, i, s) {
                /min|max|step/.test(i) && (null === e || /number|range|text/.test(e)) && (s = Number(s), isNaN(s) && (s = void 0)),
                    s || 0 === s ? t[i] = s : e === i && "range" !== e && (t["date" === e ? "dateISO" : i] = !0)
            },
            attributeRules: function(e) {
                var i, s, n = {},
                    r = t(e),
                    a = e.getAttribute("type");
                for (i in  t.validator.methods)"required" === i ? ("" === (s = e.getAttribute(i)) && (s = !0), s = !!s) : s = r.attr(i),
            ...
            dataRules: function(e) {
                var i, s, n = {},
                    r = t(e),
                    a = e.getAttribute("type");
                for (i in  t.validator.methods)"" === (s = r.data("rule" + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase())) && (s = !0),
                    this.normalizeAttributeRule(n, a, i, s);
                return n
            },
                ...
                remote: function(e, i, s, n) {
                    ...
                    return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}),
                        ...
                        o = t.param(t.extend({
                            ...
                            s.data)),
                        l.old === o ? l.valid : (l.old = o, r = this, this.startRequest(i), (a = {})[i.name] = e, t.ajax(t.extend(!0, {
                                mode: "abort",
                                ...
                                success: function(t) {
                                    ...
                                    r.settings.messages[i.name][n] = l.originalMessage,
                                        h ? (o = r.formSubmitted, r.resetInternals(), r.toHide = r.errorsFor(i), r.formSubmitted = o, r.successList.push(i), r.invalid[i.name] = !1, r.showErrors()) : (s = {},
                                            a = t || r.defaultMessage(i, {
                                                method: n,
                                                parameters: e
                                            }), s[i.name] = l.message = a, r.invalid[i.name] = !0, r.showErrors(s)),
                                        l.valid = h,
                                        r.stopRequest(i, h)
                                }
                            },
...
$.validator.addMethod("passchek", function(value, element) {
    let password = value;
    if (/12345678|87654321|(\d)\1{7}|(.)\2{7}/.test(password)) {
        return false;
    }
    return true;
    ...
    if (password.length < 7 || password.length > 20) {
        return 'رمز عبور باید حداقل 7 و حداکثر 20 کاراکتر داشته باشد.';
    }
    if (/12345678|87654321/.test(password)) {
        return 'رمز عبور نمی‌تواند اعداد به ترتیب صعودی یا نزولی باشد.';
    }
    if (/(\d)\1{7}|(.)\2{7}/.test(password)) {
        return 'رمز عبور نمی‌تواند تماماً کاراکترهای یکسان داشته باشد.';
    }
    return false;
});
...
$.validator.addMethod("arzinput", function (value, element) {
        let arzInput = value;
        if (!(/^[-0-9۰-۹,]*\.?[-0-9۰-۹,]*$/.test(arzInput))) {
            return false;
        }
        return true;
    },
    function (value, element) {
        let arzInput = $(element).val();
        if (!(/^[-0-9۰-۹,]*\.?[-0-9۰-۹,]*$/.test(arzInput))) {
            return 'تنها وارد کردن اعداد و نقطه مجاز است';
        }
        return false;
    });
...
$.validator.addMethod("dateinput", function (value, element) {
    let dateInput = value;
    if (!(/^[0-9\/-۰-۹]*$/.test(dateInput))) {
        return false;
    }
    return true;
},
function (value, element) {
    let dateInput = $(element).val();
    if (!(/^[0-9\/-۰-۹]*$/.test(dateInput))) {
        return 'تنها وارد کردن اعداد و اسلش (/) مجاز است';
    }
    return false;
});

$.validator.addMethod("enname", function (value, element) {
    let englishInput = value;
    if (!(/^[a-zA-Z\u00C0-\u017F\s]+$/.test(englishInput))) {
        return false;
    }
    return true;
},
function (value, element) {
    let englishInput = $(element).val();
    if (!(/^[a-zA-Z\u00C0-\u017F\s]+$/.test(englishInput))) {
        return 'وارد کردن حروف انگلیسی، ترکی استانبولی مجاز است';
    }
    return false;
});

$.validator.addMethod("minpric", function (value, element) {
    let minPrice = parseFloat($(element).attr('data-min-price'));
    let maxPrice = parseFloat($(element).attr('data-max-price'));
    let inputPrice = parseFloat(value.replace(/[^0-9.]/g, ''));

    if (inputPrice < minPrice) {
        $.validator.messages.minpric = 'مبلغ واریزی نمی تواند کمتر از ' + minPrice.toLocaleString() + ' تومان باشد';
        return false;
    } else if (inputPrice > maxPrice) {
        $.validator.messages.minpric = 'مبلغ واریزی نمی تواند بیشتر از ' + maxPrice.toLocaleString() + ' تومان باشد';
        return false;
    }
    return true;
}, function (value, element) {
    return 'مبلغ واریزی نامعتبر است';
});

$.validator.addMethod("withdrawpric", function (value, element) {
    let minWithdraw = parseFloat($(element).attr('data-min-price'));
    let maxWithdraw = parseFloat($(element).attr('data-max-price'));
    let withdrawAmount = parseFloat(value.replace(/[^0-9.]/g, ''));

    if (withdrawAmount < minWithdraw) {
        $.validator.messages.withdrawpric = 'مبلغ قابل برداشت نمی تواند کمتر از ' + minWithdraw.toLocaleString() + ' تومان باشد';
        return false;
    } else if (withdrawAmount > maxWithdraw) {
        $.validator.messages.withdrawpric = 'مبلغ قابل برداشت نمی تواند بیشتر از ' + maxWithdraw.toLocaleString() + ' تومان باشد';
        return false;
    }
    return true;
}, function (value, element) {
    return 'مبلغ برداشت نامعتبر است';
});
...
$('form input[required], form textarea[required]').on('input change', function() {
    var input = $(this);
    
    if (input.hasClass('error')) {
        input.parent('.input-text').removeClass('valid').addClass('error');
    } else {
        input.parent('.input-text').removeClass('error').addClass('valid');
    }
    ...
    if (input.closest('form').validate().checkForm()) {
        input.closest('form').find('.submitbtn').attr('disabled', false);
    } else {
        input.closest('form').find('.submitbtn').attr('disabled', true);
    }
